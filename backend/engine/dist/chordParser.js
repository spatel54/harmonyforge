...
function tonicToPc(tonic) {
    const idx = PITCH_CLASSES.indexOf(tonic);
    if (idx < 0)
...
function seventhInterval(quality, isDominant7) {
    if (quality === "major" && isDominant7)
        return 10; // dominant 7
    switch (quality) {
        case "major":
        case "augmented":
            return 11; // maj7
...
function degreeToRootPc(degree, key) {
...
export function parseChord(roman, key) {
