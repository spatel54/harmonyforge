...
export const PALETTE_SECTIONS: PaletteSection[] = [
  {
    ...
    items: [
      ...
      { id: "dur-dot", label: "Dot", glyph: "‥", toolId: "duration-dotted", title: "Toggle dotted rhythm on selected notes", shortcut: ".", requiresSelection: true },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "orn-trill", label: "Trill", glyph: "𝆖", toolId: "ornament-trill", title: "Rapid alternation ornament (trill)", requiresSelection: true },
      { id: "orn-turn", label: "Turn", glyph: "𝆗", toolId: "ornament-turn", title: "Ornamental turn figure", requiresSelection: true },
      { id: "orn-mordent", label: "Mordent", glyph: "𝆙", toolId: "ornament-mordent", title: "Lower mordent (main note → lower neighbor → main)", requiresSelection: true },
      { id: "orn-mordent-upper", label: "Upper Mordent", glyph: "𝆙", toolId: "ornament-mordent-upper", title: "Upper / inverted mordent (main → upper neighbor → main)", requiresSelection: true },
    ],
  },
  {
    id: "dynamics",
    ...
    items: [
      ...
      { id: "dyn-cresc", label: "cresc.", toolId: "dynamics-cresc", title: "Gradually get louder (crescendo hairpin)", requiresSelection: true },
      { id: "dyn-dim", label: "dim.", toolId: "dynamics-decresc", title: "Gradually get softer (diminuendo hairpin)", requiresSelection: true },
    ],
  },
  {
    id: "lines",
