...
export function ExportFormatCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
          "hf-pressable flex flex-col items-center justify-center gap-2 h-[92px] w-full rounded-xl transition-[transform,box-shadow,border-color,background-color] duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--hf-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--hf-panel-bg)]",
        selected
