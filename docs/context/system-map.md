...
**Repository layout:**
- `backend/` — Node package: `engine/` (REST API, parsers, solver), `scripts/`, CLI `input/` / `output/`
- `frontend/` — Tactile Sandbox (Next.js); RiffScore-based score editor, Theory Inspector UI, `patch-package` for `riffscore`
- `docs/` — Plan, progress, ADRs, context, `Taxonomy.md`
- `miscellaneous/` — Legacy `chamber-music-fullstack/`, vendored `pdfalto/`, ancillary tooling
