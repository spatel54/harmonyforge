...
import { inRange, pitchToMidi } from "./types.js";
...
function perfectIntervalPairs(prev, curr, targetSemitones) {
    const matches = [];
    for (const [v1, v2] of PAIRS) {
        ...
        if (intervalSemitones(p1a, p1b) === targetSemitones &&
...
function overlapPairs(prev, curr) {
...
export function validateSATBSequenceWithTrace(slots) {
    const violations = {
        parallelFifths: 0,
        parallelOctaves: 0,
        rangeViolations: 0,
